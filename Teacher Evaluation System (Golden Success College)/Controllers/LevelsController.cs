...
namespace Teacher_Evaluation_System__Golden_Success_College_.Controllers
{
    public class LevelsController : Controller
    {
        ...
        public LevelsController(Teacher_Evaluation_System__Golden_Success_College_Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("LevelId,LevelName,Description")] Level level)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LevelId,LevelName,Description")] Level level)
        {
            if (id != level.LevelId)
            {
                return NotFound();
